...
export default function Favoritos() {
    ...
    return (
        <div className="flex flex-col flex-wrap ">
            <h1 className='m-2 text-[#1479FF] text-xl font-poppins  mt-3 mb-8'>Estos son tus <span className='text-[#292F53]'>Doctores</span> Favoritos!</h1>
                            ...
                            <Link to ={`/patient/doctors/${ele.doctor._id}`}>
                                <section className='lg:w-[520px] bg-[#f9f9fa]  h-fit mt-10 flex flex-col p-3 rounded-xl items-center shadow-md w-[330px]' >
                                    ...
                                    <img src={ele.doctor.image} alt={ele.doctor.name} className='w-36 h-36 rounded-xl object-cover lg:ml-2 ml-6 mt-5 shadow-md'/>
                                        ...
                                        <p className='font-poppins text-white mt-2 mb-2 bg-[#1479FF] rounded-lg p-2 w-fit'> Costo de consulta: $ {ele.doctor.checkUpPrice}</p>
